<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:93:"D:\phpStudy\PHPTutorial\WWW\twothink\public/../application/home/view/default/index\index.html";i:1552975341;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
...
<div class="main">
    ...
    <div class="container-fluid">
        <div class="indexImg row">
            <img src="/static/home/static/image/index.png" width="100%" />
        </div>
        <div class="serviceList text-center">
            <div class="container">
                <div class="row">
                    <div class="col-xs-4">
                        <a href="<?php echo url('Notice/index?info=43&on_page=1'); ?>">
                    ...
                    <div class="col-xs-4">
                        <a href="<?php echo url('Notice/index?info=44&on_page=1'); ?>">
                    ...
                    <div class="col-xs-4">
                        <a href="<?php echo url('Propert/add'); ?>">
                    ...
                    <div class="col-xs-4">
                        <a href="<?php echo url('Notice/index?info=45&on_page=1'); ?>">
                    ...
                    <div class="col-xs-4">
                        <a href="<?php echo url('Notice/index?info=46&on_page=1'); ?>">
