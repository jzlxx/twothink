<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:94:"D:\phpStudy\PHPTutorial\WWW\twothink\public/../application/home/view/default/propert\edit.html";i:1552966905;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
...
<div class="main">
    ...
    <div class="container-fluid">
        <form action="<?php echo url('Propert/add'); ?>" method="post">
            ...
            <!--</div>-->
            <div class="form-group">
                <button type="submit" class="btn btn-primary onlineBtn">确认提交</button>
            </div>
        </form>
    </div>
</div>
