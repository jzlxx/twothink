<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:94:"D:\phpStudy\PHPTutorial\WWW\twothink\public/../application/home/view/default/notice\index.html";i:1552981314;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
...
<div class="main">
    ...
    <div class="container-fluid">
        <div id="test">
            <?php if(is_array($_list) || $_list instanceof \think\Collection || $_list instanceof \think\Paginator): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$notice): $mod = ($i % 2 );++$i;?>
            <div class="row noticeList">
                <a href="<?php echo url('info?id='.$notice['id']); ?>">
                <div class="col-xs-2">
        ...
        <div id="a" style="border: 1px solid #cbcbcb;width: 100%;text-align: center;border-radius: 5px">
            <?php
                if($a){
            ?>
            <a class="btn" onclick="test(<?php echo $count; ?>,<?php echo $on_page; ?>,<?php echo $info; ?>)">点击查看更多</a>
            <?php
                }else{
            ?>
            <a class="btn">没有更多了</a>
...
<script>
    function test($count,$on_page,$info) {
        ...
        ajax.open('get','http://www.tp.test/home/notice/getPage/info/'+$info+'/on_page/'+new_page);
        ajax.send();
        ajax.onreadystatechange=function () {
            if(ajax.readyState=='4'&&ajax.status=='200'){
                ...
                if(data['on_page']>=$count){
                    ...
                    $('#a').html('<a class="btn" onclick="test(<?php echo $count; ?>,'+data['on_page']+',<?php echo $info; ?>)">点击查看更多</a>')
                }
            }
        }
    }
