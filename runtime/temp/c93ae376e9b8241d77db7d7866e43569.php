<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:102:"D:\phpStudy\PHPTutorial\WWW\twothink\public/../application/admin/view/default/user\updatenickname.html";i:1496373782;s:94:"D:\phpStudy\PHPTutorial\WWW\twothink\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<body>
	...
	<!-- 标题栏 -->
		...
		<li class="current"><a href="<?php echo url('updatenickname'); ?>">修改昵称</a></li>
		<li ><a href="<?php echo url('updatepassword'); ?>">修改密码</a></li>
		</ul>
		<div class="tab-content">
	<!-- 修改密码表单 -->
    <form action="<?php echo url('User/submitNickname'); ?>" method="post" class="form-horizontal" autocomplete="off">
		<div class="form-item">
