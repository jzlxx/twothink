<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:93:"D:\phpStudy\PHPTutorial\WWW\twothink\public/../application/home/view/default/notice\info.html";i:1552967756;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
...
<div class="main">
    ...
    <div class="container-fluid">
        ...
        <div class="noticeDetailInfo">发布时间：<?php echo time_format($notice['create_time']); ?></div>
        ...
        <div>
            ...
            ?>
                <a class="btn btn-info" href="<?php echo url('Notice/eve?aid='.$notice['id']); ?>">报名</a>
            <?php
                }}else{
            ?>
