<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:93:"D:\phpStudy\PHPTutorial\WWW\twothink\public/../application/user/view/default/login\index.html";i:1552635688;s:93:"D:\phpStudy\PHPTutorial\WWW\twothink\public/../application/user/view/default/base\common.html";i:1552635547;s:90:"D:\phpStudy\PHPTutorial\WWW\twothink\public/../application/user/view/default/base\var.html";i:1496373782;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="UTF-8">
	    ...
	    <!--<div class="navbar-inner">-->
	        <!--<div class="container">-->
	            ...
	            <!--<div class="nav-collapse collapse">-->
	                <!--<ul class="nav"> -->
		                <!--<?php $__NAV__ = \think\Db::name('Channel')->field(true)->where("status=1")->order("sort")->select();if(is_array($__NAV__) || $__NAV__ instanceof \think\Collection || $__NAV__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__NAV__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$nav): $mod = ($i % 2 );++$i;?> -->
		                    <!--<?php if($nav['pid'] == '0'): ?>-->
		                        <!--<li>-->
  ...
  <section>
    <div class="span12">
      <form class="login-form" action="" method="post">
        ...
        <div class="form-group">
          <label  for="inputVerify">验证码</label>
          <div class="controls">
        ...
        <div class="form-group">
          <div class="controls">
            <button type="submit" class="btn btn-primary form-control">登 陆</button>
