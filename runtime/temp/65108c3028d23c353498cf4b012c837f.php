<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:94:"D:\phpStudy\PHPTutorial\WWW\twothink\public/../application/home/view/default/notice\about.html";i:1552968303;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
...
<div class="main">
    ...
    <div class="container-fluid">
        <div class="blank"></div>
        <h3 class="noticeDetailTitle"><strong><?php echo $about['title']; ?></strong></h3>
        <div class="noticeDetailContent">
            <?php echo $about_article['content']; ?>
        </div>
    </div>
</div>
