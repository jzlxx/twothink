<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:95:"D:\phpStudy\PHPTutorial\WWW\twothink\public/../application/admin/view/default/notice\index.html";i:1552707376;s:94:"D:\phpStudy\PHPTutorial\WWW\twothink\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<body>
	...
	<div class="main-title">
		<h2>
			<?php if(isset($data)): ?>[ <?php echo $data['title']; ?> ] 子<?php endif; ?>小区通知
		</h2>
	</div>
	...
	<div class="cf">
		...
		<!--<div class="fl">-->
			<!--<div class="btn-group">-->
				<!--<?php if($allow > '0'): ?>-->
					...
					<!--&lt;!&ndash;<ul class="dropdown nav-list">&ndash;&gt;-->
						<!--&lt;!&ndash;<?php if(is_array($model) || $model instanceof \think\Collection || $model instanceof \think\Paginator): $i = 0; $__LIST__ = $model;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>&ndash;&gt;-->
						<!--&lt;!&ndash;<li><a href="<?php echo url('article/add',array('cate_id'=>$cate_id,'model_id'=>$vo,'pid'=>input('pid',0),'group_id'=>$group_id)); ?>"><?php echo get_document_model($vo,'title'); ?></a></li>&ndash;&gt;-->
				...
				<!--<?php endif; ?>-->
			<!--</div>-->
            <!--&lt;!&ndash;<button class="btn ajax-post" target-form="ids" url="<?php echo url("Article/setStatus",array("status"=>1,'cate_id'=>input('cate_id'))); ?>">启 用</button>&ndash;&gt;-->
			<!--&lt;!&ndash;<button class="btn ajax-post" target-form="ids" url="<?php echo url("Article/setStatus",array("status"=>0,'cate_id'=>input('cate_id'))); ?>">禁 用</button>&ndash;&gt;-->
			<!--&lt;!&ndash; <button class="btn ajax-post" target-form="ids" url="<?php echo url("Article/move"); ?>">移 动</button>-->
			<!--<button class="btn ajax-post" target-form="ids" url="<?php echo url("Article/copy"); ?>">复 制</button>-->
			<!--<button class="btn ajax-post" target-form="ids" hide-data="true" url="<?php echo url("Article/paste"); ?>">粘 贴</button> &ndash;&gt;-->
			<!--&lt;!&ndash;<input type="hidden" class="hide-data" name="cate_id" value="<?php echo $cate_id; ?>"/>&ndash;&gt;-->
			<!--&lt;!&ndash;<input type="hidden" class="hide-data" name="pid" value="<?php echo $pid; ?>"/>&ndash;&gt;-->
			...
			<!--&lt;!&ndash; <button class="btn document_add" url="<?php echo url('article/batchOperate',array('cate_id'=>$cate_id,'pid'=>input('pid',0))); ?>">导入</button> &ndash;&gt;-->
			<!--&lt;!&ndash;<button class="btn list_sort" url="<?php echo url('sort',array('cate_id'=>$cate_id,'pid'=>input('pid',0)),''); ?>">排序</button>&ndash;&gt;-->
			<!--&lt;!&ndash;<div class="btn-group"> &ndash;&gt;-->
			    <!--&lt;!&ndash;<a class="btn" href="<?php echo url('recycle',['model_id'=>$model_id]); ?>">回收站</a> &ndash;&gt;-->
			<!--&lt;!&ndash;</div>&ndash;&gt;-->
		<!--</div>-->
