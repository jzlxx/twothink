<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:93:"D:\phpStudy\PHPTutorial\WWW\twothink\public/../application/home/view/default/notice\fuwu.html";i:1552981232;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
...
<div class="main">
    ...
    <div class="container-fluid">
        <div class="indexImg row">
            <img src="/static/home/static/image/3.png" width="100%" />
        </div>
        <div class="blank"></div>
        <div class="container">
            <ul class="list-group fuwuList">
                ...
                <li class="list-group-item"><a href="<?php echo url('Notice/tieshi?on_page=3'); ?>" class="text-warning"><span class="iconfont">&#xe601;</span>生活贴士</a></li>
                <li class="list-group-item"><a href="<?php echo url('Notice/about'); ?>" class="text-primary"><span class="iconfont">&#xe600;</span>关于我们</a></li>
            </ul>
        </div>
    </div>
</div>
