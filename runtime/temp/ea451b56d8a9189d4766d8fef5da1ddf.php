<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:95:"D:\phpStudy\PHPTutorial\WWW\twothink\public/../application/admin/view/default/propert\edit.html";i:1552624714;s:94:"D:\phpStudy\PHPTutorial\WWW\twothink\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<body>
    ...
    <div class="main-title">
        <h2><?php echo isset($info['id'])?'编辑':'新增'; ?>报修信息</h2>
    </div>
    <form action="<?php echo url(); ?>" method="post" class="form-horizontal">
        ...
        <div class="form-item">
            ...
            <div class="controls">
                <textarea name="content" id="" cols="30" rows="10" class="textarea input-large"><?php echo (isset($info['content']) && ($info['content'] !== '')?$info['content']:''); ?></textarea>
            </div>
        </div>
        <div class="form-item">
