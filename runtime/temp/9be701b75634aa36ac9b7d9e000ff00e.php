<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:96:"D:\phpStudy\PHPTutorial\WWW\twothink\public/../application/admin/view/default/propert\group.html";i:1552632193;s:94:"D:\phpStudy\PHPTutorial\WWW\twothink\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<body>
    ...
    <div class="main-title">
        <h2><?php if(isset($data)): ?>[ <?php echo $data['title']; ?> ] 子<?php endif; ?>报修管理 </h2>
    </div>
    ...
    <div class="cf">
        ...
        <div class="search-form fr cf">
            <div class="sleft">
                <input type="text" name="title" class="search-input" value="<?php echo input('title'); ?>" placeholder="请输入报修标题">
                <a class="sch-btn" href="javascript:;" id="search" url="<?php echo url('group'); ?>"><i class="btn-search"></i></a>
            </div>
        </div>
    </div>
    ...
    <div class="data-table table-striped">
        <form class="ids">
            <table>
                ...
                <tbody>
				<?php if(!(empty($list) || (($list instanceof \think\Collection || $list instanceof \think\Paginator ) && $list->isEmpty()))): if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$propert): $mod = ($i % 2 );++$i;?>
                    <tr>
                        <td><input class="ids row-selected" type="checkbox" name="id[]" value="<?php echo $propert['id']; ?>"></td>
                        <td><?php echo $propert['id']; ?></td>
                        <td><?php echo $propert['title']; ?></a></td>
                        <td><?php echo $propert['name']; ?></td>
                        <td><?php echo $propert['address']; ?></td>
                        <td><?php echo $propert['tel']; ?></td>
                        <td><?php echo $propert['create_time']; ?></td>
                        <td>
                            <a title="编辑" href="<?php echo url('edit?id='.$propert['id']); ?>">编辑</a>
                            <a class="confirm ajax-get" title="删除" href="<?php echo url('del?id='.$propert['id']); ?>">删除</a>
                        </td>
                    </tr>
    ...
    <script type="text/javascript">
        $(function() {
            ...
            //导航高亮
            highlight_subnav('<?php echo url('group'); ?>');
            //点击排序
