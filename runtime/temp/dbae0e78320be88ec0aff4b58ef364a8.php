<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:97:"D:\phpStudy\PHPTutorial\WWW\twothink\public/../application/home/view/default/notice\zsdetail.html";i:1552977187;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
...
<div class="main">
    ...
    <div class="container-fluid">
        <div class="blank"></div>
        <h3 class="noticeDetailTitle"><strong><?php echo $zs['title']; ?></strong></h3>
        <div class="noticeDetailInfo">发布者:<?php echo $user['nickname']; ?></div>
        <div class="noticeDetailInfo">发布时间：<?php echo time_format($zs['create_time']); ?></div>
        <!--<div class="noticeDetailInfo">联系电话：13800138000</div>-->
        <h4 class="text-danger"><?php echo $zs_article['content']; ?></h4>
        <div class="noticeDetailContent">
            <img src="/static/home/static/image/2.png" />
        </div>
    </div>
</div>
