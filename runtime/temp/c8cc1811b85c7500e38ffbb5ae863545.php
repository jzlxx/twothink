<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:101:"D:\phpStudy\PHPTutorial\WWW\twothink\public/../application/admin/view/default/auth_manager\group.html";i:1496373782;s:94:"D:\phpStudy\PHPTutorial\WWW\twothink\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<body>
    ...
    <div id="auth_groups">
        <form class="form-horizontal" action="<?php echo url('addToGroup'); ?>" method="post" enctype="application/x-www-form-urlencoded" >
			<label class="item-label"><?php echo $nickname; ?> 所属的用户组列表</label>
            <?php if(is_array($auth_groups) || $auth_groups instanceof \think\Collection || $auth_groups instanceof \think\Paginator): $i = 0; $__LIST__ = $auth_groups;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                <label class="checkbox">
                    <input class="auth_groups" type="checkbox" name="group_id[]" value="<?php echo $vo['id']; ?>"><?php echo $vo['title']; ?>
                </label>
            <?php endforeach; endif; else: echo "" ;endif; ?>
            <input type="hidden" name="uid" value="<?php echo input('uid'); ?>">
