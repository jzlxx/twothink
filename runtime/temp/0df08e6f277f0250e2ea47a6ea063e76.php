<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:93:"D:\phpStudy\PHPTutorial\WWW\twothink\public/../application/user/view/default/index\index.html";i:1552967844;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
...
<div class="main">
    ...
    <nav class="navbar navbar-default navbar-fixed-bottom">
        <div class="container-fluid text-center">
            <div class="col-xs-3">
                <p class="navbar-text"><a href="<?php echo url('Home/Home/index'); ?>" class="navbar-link">首页</a></p>
            </div>
            <div class="col-xs-3">
                <p class="navbar-text"><a href="<?php echo url('Home/Notice/fuwu'); ?>" class="navbar-link">服务</a></p>
            </div>
            <div class="col-xs-3">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-xs-3">
                <img src="/static/home/static/image/5.png" width="60" height="60" />
            </div>
            <div class="col-xs-9">
                ZhangSan<br/>
                北大花园小区<br/>
